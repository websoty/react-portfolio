# Portfolio created in React ( currently in development, minor updates ongoing )
...
## In Progress / Upcoming Updates
- Improving accessibility (ARIA labels, keyboard navigation)
- Expanding animation variants for smoother transitions
- CV download feature, ability to download a PDF resume directly from the portfolio
